...
<![endif]-->
<link href="${ares}/static/h-ui/css/H-ui.min.css" rel="stylesheet"
	type="text/css" />
<link href="${ares}/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet"
	type="text/css" />
<link href="${ares}/static/h-ui.admin/css/style.css" rel="stylesheet"
	type="text/css" />
<link href="${ares}/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet"
	type="text/css" />
<!--[if IE 6]>
...
<body>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			<form class="form form-horizontal" action="logins" method="post">
				<div class="row cl">
